...
export default function AssignFuelToPump({
  open,
  setOpen,
  row,
  ...
  useEffect(() => {
    setValue("fuelId", data?.fuels.length > 0 ? data.fuels[0].id : 0);
    setValue("pumpId", row?.original?.id);
    setValue("volume", 0);
  }, [data]);
          ...
          >
            <div className="grid grid-cols-1  gap-2">
              ...
              <Input
                ...
                className="border focus:outline-none focus:ring-0 focus:ring-offset-0"
              />

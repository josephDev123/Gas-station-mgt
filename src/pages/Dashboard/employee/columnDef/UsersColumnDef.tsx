...
import { IUser as IMainUser } from "@/types/IUser";
import EditDeleteUserBtn from "../components/EditDeleteUserBtn";

export function UsersColumnDef(session: IMainUser): ColumnDef<IUser>[] {
  const usersColumnDef: ColumnDef<IUser>[] = [
    {
      header: "S/N",
